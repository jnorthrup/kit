...
public class PacketKexInit {
    ...
    private KexParameters kp = new KexParameters();
    ...
    public PacketKexInit(byte payload[], int off, int len) throws IOException {
        ...
        kp.encryption_algorithms_client_to_server = tr.readCipherList();
        kp.encryption_algorithms_server_to_client = tr.readCipherList();
    ...
    public byte[] getPayload() {
        if (payload == null) {
            ...
            tw.writeCipherList(kp.encryption_algorithms_client_to_server);
            tw.writeCipherList(kp.encryption_algorithms_server_to_client);
    ...
    public CipherEntry[] getEncryption_algorithms_client_to_server() {
        return kp.encryption_algorithms_client_to_server;
    }

    public CipherEntry[] getEncryption_algorithms_server_to_client() {
