...
public class TypesReader {
    ...
    public CipherEntry[] readCipherList() throws IOException {
        String[] strings = readNameList();
        ArrayList<CipherEntry> list = new ArrayList<CipherEntry>();
        for (String string : strings) {
            list.add(CipherEntry.getEntry(string));

        }
        return list.toArray(new CipherEntry[]{});
