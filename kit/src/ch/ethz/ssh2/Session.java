 ...
 * @version $Id: Session.java,v 1.10 2006/11/01 14:20:24 cplattne Exp $
 */
public class Session {
    ...
    public void requestX11Forwarding(String hostname, int port, byte[] cookie, boolean singleConnection)
        ...
        while (true) {
            ...
            for (byte aFakeCookie : fakeCookie) {
                String digit2 = Integer.toHexString(aFakeCookie & 0xff);
    ...
    public int waitUntilDataAvailable(long timeout) {
        ...
        int conditions = ChannelManager.waitForCondition(cn, timeout, ChannelCondition.STDOUT_DATA | ChannelCondition.STDERR_DATA
    ...
    public int waitForCondition(int condition_set, long timeout) {
        ...
        return ChannelManager.waitForCondition(cn, timeout, condition_set);
    }
