...
class KnownHosts {
    private static final int HOSTKEY_IS_OK = 0;
    private static final int HOSTKEY_IS_NEW = 1;
    private static final int HOSTKEY_HAS_CHANGED = 2;

    private static class KnownHostsEntry {
        String[] patterns;
        Object key;
    ...
    private String[] recommendHostkeyAlgorithms(String hostname) {
        ...
        for (int i = 0; i < keys.size(); i++) {
            ...
            if (keys.elementAt(i) instanceof RSAPublicKey) thisAlgo = "ssh-rsa";
            else if (keys.elementAt(i) instanceof DSAPublicKey) thisAlgo = "ssh-dss";
            else continue;
